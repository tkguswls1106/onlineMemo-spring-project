...
public interface FriendshipService {
    ...
    void updateFriendship(Long userId, FriendshipUpdateRequestDto friendshipUpdateRequestDto);  // 친구요청 수신자는 userId, 발신자는 senderUserId에 해당되는 요청 친구에 대한 친구 맺기 여부 수정 기능.
