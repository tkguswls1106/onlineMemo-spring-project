...
public interface UserStore {
    ...
    Long create(UserJoinRequestDto userJoinRequestDto);  // 사용자 생성하고, 해당 사용자id 반환.
    ...
    void updatePw(UserJoinRequestDto userJoinRequestDto, String firstPw);  // 해당 사용자의 1차비밀번호 수정.

    void updateName(UserJoinRequestDto userJoinRequestDto, String username);  // 해당 사용자의 이름 수정.
